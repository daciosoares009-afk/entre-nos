  ...
  return (
    <section className="container-page py-8 sm:py-12">
      <article className="mx-auto max-w-3xl rounded-lg bg-white p-4 leading-7 shadow-soft sm:p-8">
        ...
        <h2 className="mt-6 text-xl font-bold text-dark">Seus direitos</h2>
        <p className="mt-3 text-muted">
          Você pode solicitar confirmação do tratamento, acesso, correção, anonimização, bloqueio, eliminação ou portabilidade dos dados, além de informações sobre compartilhamento e revogação do consentimento, quando aplicável. As solicitações devem ser enviadas pelos canais oficiais do Entre Nós.
        </p>
        <h2 className="mt-6 text-xl font-bold text-dark">Conservação e segurança</h2>
        <p className="mt-3 text-muted">
          Os dados serão mantidos pelo período necessário para cumprir as finalidades informadas e obrigações legais. Adotamos medidas razoáveis para evitar acesso não autorizado, perda, alteração ou divulgação indevida.
        </p>
      </article>
    </section>
  );
