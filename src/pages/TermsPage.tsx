    ...
    <section className="container-page py-12">
      <article className="mx-auto max-w-3xl rounded-lg bg-white p-6 leading-7 shadow-soft sm:p-8">
        ...
        <p className="mt-4 text-muted">
          A inscrição registra o interesse de participação no Entre Nós Experience. O ingresso será validado após confirmação manual do pagamento pela equipe organizadora.
        </p>
        <p className="mt-4 text-muted">
